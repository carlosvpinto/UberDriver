...
class HistoriesDriverAdapter(val context: Activity, val histories: ArrayList<History>): RecyclerView.Adapter<HistoriesDriverAdapter.HistoriesAdapterViewHolder>() {
