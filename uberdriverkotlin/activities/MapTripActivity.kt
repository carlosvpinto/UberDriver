...
/// CAMBIA ESTADO DEL BOOKING A STARTED ***********************
    private fun updateToStarted() {
        ...
        //*****************************************************
    Log.d("DISTANCIA", " AFUERA ANTES fUNCION updateToStarted destinationLatLng: $destinationLatLng")
        if (isCloseToOrigin) {
            ...
            bookingProvider.updateStatus(bookingExtra?.idClient!!, "started").addOnCompleteListener {
                ...
                progressDialog.hideProgressBar(this)
                if (it.isSuccessful) {
                    Log.d("DISTANCIA", " fUNCION updateToStarted destinationLatLng: $destinationLatLng")
                    if (destinationLatLng != null) {
                        isStartedTrip = true
                        googleMap?.clear()
